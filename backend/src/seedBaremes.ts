...
/**
 * Seed des barèmes de base pour l'application
 * Exécuter avec: npm run seed:baremes
 */

const baremesData = [
  // ========== TAUX HORAIRES par genre de véhicule ==========
  {
    type: 'taux_horaire' as const,
    genreVehicule: 'VP',
    valeur: 15000,
    unite: 'FCFA/heure',
    actif: true,
  ...
  // ========== VÉTUSTÉ par âge du véhicule ==========
  {
    type: 'vetuste' as const,
    ageVehiculeMin: 0,
    ageVehiculeMax: 1,
    valeur: 10,
    unite: '%',
  ...
  // ========== FRAIS DE DÉPLACEMENT par kilomètres ==========
  {
  ...
  // ========== HONORAIRES par montant du rapport ==========
  {
    type: 'honoraire' as const,
    montantMin: 0,
    montantMax: 500000,
    valeur: 25000,
    unite: 'FCFA',
...
async function seedBaremes() {
  try {
    ...
    console.log(`  - Taux horaires : 4 barèmes (VP, VU, camion, moto)`);
    console.log(`  - Vétusté : 6 tranches d'âge`);
    console.log(`  - Frais déplacement : 5 tranches de kilomètres`);
    console.log(`  - Honoraires : 5 tranches de montant`);
